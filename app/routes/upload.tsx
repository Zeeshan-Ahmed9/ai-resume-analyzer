...
const upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        try {
            ...
            console.error(error);
            setStatusText(`Error: ${error instanceof Error ? error.message : "An unknown error occurred"}`);
        }
    }
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    ...
                    {isProcessing ? (
                        ...
                        <h2>Drop your resume for your ATS score and improvement suggestions</h2>
                    )}
                    {!isProcessing && (
